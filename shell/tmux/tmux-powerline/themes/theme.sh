...
if patched_font_in_use; then
	...
	TMUX_POWERLINE_SEPARATOR_RIGHT_SLASH="◣"
	TMUX_POWERLINE_SEPARATOR_LEFT_SLASH="◢"
else
	TMUX_POWERLINE_SEPARATOR_LEFT_BOLD="◀"
	TMUX_POWERLINE_SEPARATOR_LEFT_THIN="❮"
	TMUX_POWERLINE_SEPARATOR_RIGHT_BOLD="▶"
...
# run "~/.config/tmux/plugins/tmux-powerline/color_palette.sh" to see the supported colors
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR:-'0'}
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-'24'}
