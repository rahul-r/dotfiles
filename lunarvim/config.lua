...
-- Patterns to set the working directory. This setting is used to automatically change the directory
-- to the one matching the given patterns
lvim.builtin.project.patterns = { ".git", "_darcs", ".hg", ".bzr", ".svn" } -- { ".git", "_darcs", ".hg", ".bzr", ".svn", "Makefile", "package.json", "pom.xml" }
